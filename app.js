window.addEventListener('load', () => {
    const form = document.querySelector("#new-gratitude-form");
    const input = document.querySelector("#new-gratitude-input");
    ...
    form.addEventListener('submit', (e) => {
        ...
        item_edit_el.addEventListener('click', () => {
            if (item_edit_el.innerText.toLocaleLowerCase() === "edit") {
